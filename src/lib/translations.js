...
const translations = {
  ...
  en: {
    ...
    welcomeBodyShort: (projectName) => `Here\'s everything about the ${projectName}, explained step by step.`,
  ...
  es: {
    ...
    welcomeBodyShort: (projectName) => `Aquí tiene todo sobre ${projectName}, explicado paso a paso.`,
  ...
  fr: {
    ...
    welcomeBodyShort: (projectName) => `Voici tout ce qu'il faut savoir sur ${projectName}, expliqué étape par étape.`,
